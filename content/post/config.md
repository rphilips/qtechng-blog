...
- items:
  ...
  - enum: Een wildcard voorstelling op de relatieve `qtechpath` naam van bestanden (dit is relatief ten opzichte van het project).
...
- items:
  ...
  - enum: Een wildcard voorstelling voor de registry waarde `system-group`.
...
- items:
  ...
  - enum: Een wildcard voorstelling voor de registry waarde `system-name`.
...
- items:
  ...
  - enum: Een wildcard voorstelling voor de registry waarde `system-roles`.
